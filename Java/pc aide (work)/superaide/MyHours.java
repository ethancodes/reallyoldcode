...
public class MyHours
{
  ...
  public void CalcHours(String id)
  {
   ...
   public void Disp()
   {
     ...
     double addedTimes = bd.addTimes(week1, week2);  
     int w1h = (int)(week1 / 100);
     int w1m = (int)((week1 % 100) * 100 / 60);
     int w2h = (int)(week2 / 100);
     int w2m = (int)((week2 % 100) * 100 / 60);
     int toth = (int)(addedTimes / 100);
     int totm = (int)((addedTimes % 100) * 100 / 60);
     Week1.setText("Week 1 Hours: " + w1h + "." + w1m );
     Week2.setText("Week 2 Hours: " + w2h + "." + w2m );
     Total.setText("Total Hours:  " + toth + "." + totm );
